"""内置 locator 修复策略 —— 3 种，均为 ``NeedleSolution`` 子类。
...
from needle.builtin.backends import (
    AIClient,
    CacheBackend,
    ImageMatcher,
    OpenCVImageMatcher,
...
from needle.core.context import PlaywrightContextBuilder
from needle.core.solution import NeedleSolution

logger = logging.getLogger(__name__)


class _LocatorSolutionBase(NeedleSolution):
